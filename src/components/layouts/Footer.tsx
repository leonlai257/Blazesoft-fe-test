                ...
                <div className="flex w-full flex-col justify-start gap-y-5">
                    <div className="flex flex-col justify-between md:flex-row">
                        <div className="flex w-fit flex-col items-start gap-y-5">
                            ...
                            <Text responsive="body">Here is a brand message</Text>
                                                    ...
                                                    {section.items.map((item, index) => {
                                                        return (
                                                            <Link
                                                                ...
                                                                <Text responsive="body">{item.name}</Text>
                                                            </Link>
                                                        )
                                                    })}
                                                </div>
                    ...
                    <div className="mb-5 flex w-full justify-center">
                        <Text responsive="body">Copyright © 2024 Company Ltd. All rights reserved.</Text>
                    </div>
                </div>
            </div>
        </>
